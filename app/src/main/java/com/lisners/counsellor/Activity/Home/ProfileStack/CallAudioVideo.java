...
public class CallAudioVideo extends AppCompatActivity {

    EditText edit_chanel ;
    Button btn_connect ;
    private static final String LOG_TAG = CallAudioVideo.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_call_audio_video);
        // Initialize RtcEngine and join a channel after getting the permission.
        edit_chanel = findViewById(R.id.edit_chanel);
        ...
        btn_connect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String s =edit_chanel.getText().toString();
                joinChannel(s);
            }
        });
    }
    private void initAgoraEngineAndJoinChannel() {
        ...
        joinChannel("Abc");               // Tutorial Step 2
    }
    ...
    public void onLocalAudioMuteClicked(View view) {
        ...
        if (iv.isSelected()) {
            ...
            iv.setSelected(true);
            iv.setColorFilter(getResources().getColor(R.color.primary), PorterDuff.Mode.MULTIPLY);
        }
    ...
    // Tutorial Step 2
    private void joinChannel(String channeltext) {
        String accessToken = "";
        ...
        mRtcEngine.joinChannel(accessToken, channeltext, "Extra Optional Data", 0); // if you do not specify the uid, we will generate the uid for you
    }
