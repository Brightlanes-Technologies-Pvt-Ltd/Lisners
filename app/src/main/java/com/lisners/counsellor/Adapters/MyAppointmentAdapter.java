...
public class MyAppointmentAdapter extends RecyclerView.Adapter<MyAppointmentAdapter.MyViewHolder> {
    ...
    MyAppointmentAdapter.OnItemClickListener listener;
    ...
    public MyAppointmentAdapter(Context context, MyAppointmentAdapter.OnItemClickListener listener) {
    ...
    public MyAppointmentAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_appointment_inner, parent, false);
        MyAppointmentAdapter.MyViewHolder holder = new MyAppointmentAdapter.MyViewHolder(view);
        return holder;
    }


    @Override
    public void onBindViewHolder(@NonNull final MyAppointmentAdapter.MyViewHolder holder, int position) {
        ...
        if (item.getCall_time() != null)
            holder.tv_sec_time.setText(item.getCall_time() + " sec");
        else
            holder.tv_sec_time.setText("");
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvPrice, tv_name, tv_spacilization, tv_date_time, tv_sec_time, tv_short_name, status;
        ...
        public MyViewHolder(View itemView) {
            ...
            tv_sec_time = itemView.findViewById(R.id.tv_sec_time);
